...
####3. To train the model, I used Adam optimizer with batch size 128, epoch 60, keep probability of 0.6 for training and learning rate 0.0005
...
####3. The code for making predictions on my final model is located in the 30th cell of the Ipython notebook.
